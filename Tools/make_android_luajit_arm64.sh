...
cp build_lj_v8a/libxlua.so ../build/plugin_luajit/Plugins/Android/libs/arm64-v8a/libxlua.so
...
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=armeabi-v7a -DCMAKE_TOOLCHAIN_FILE=../cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=arm-linux-androideabi-4.9 -DANDROID_NATIVE_API_LEVEL=android-21 ../src/xLua.Native/
cd "$DIR"
