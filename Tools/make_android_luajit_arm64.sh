...
cd "$DIR"
mkdir -p ../build/intermediates/build_lj_v8a && pushd ../build/intermediates/build_lj_v8a
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=arm64-v8a -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=arm-linux-androideabi-clang -DANDROID_NATIVE_API_LEVEL=android-21 ../../../src/xLua.Native/
cd "$DIR"
cmake --build ../build/intermediates/build_lj_v8a --config Release
mkdir -p ../build/plugin_luajit/Plugins/Android/libs/arm64-v8a/
cp ../build/intermediates/build_lj_v8a/libxlua.so ../build/plugin_luajit/Plugins/Android/libs/arm64-v8a/libxlua.so
...
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=armeabi-v7a -DCMAKE_TOOLCHAIN_FILE=../../../src/xLua.Native/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=arm-linux-androideabi-4.9 -DANDROID_NATIVE_API_LEVEL=android-21 ../../../src/xLua.Native/
cd "$DIR"
...
cmake -DUSING_LUAJIT=ON -DANDROID_ABI=x86 -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_TOOLCHAIN_NAME=x86-clang -DANDROID_NATIVE_API_LEVEL=android-21 ../../../src/xLua.Native/
cd "$DIR"
